...
export default area({
  ...
  modules: [
    module({
      ...
      concepts: [
        concept({ order: 10, title: "Abstraction", note: "raiz de tudo", revisit: ["Software Design / OOD", "Architecture Fundamentals"] }),
        concept({ order: 20, title: "Encapsulation", requires: ["Abstraction"], revisit: ["Software Design / OOD"] }),
        concept({
          order: 30,
        ...
        concept({ order: 60, title: "Inheritance", requires: ["Encapsulation"], revisit: ["Software Design / OOD", "SOLID / LSP"] }),
        concept({
          order: 70,
          title: "Polymorphism",
    ...
    module({
      ...
      concepts: [
        ...
        concept({ order: 40, title: "Type Safety", requires: ["Strong vs Weak Typing"], note: "a propriedade resultante", revisit: ["todo o roadmap assume", "Software Design / DIP"] }),
        concept({ order: 50, title: "Nominal Typing", requires: ["Type Safety"] }),
        concept({ order: 60, title: "Structural Typing", requires: ["Nominal Typing"], note: "ensinar como contraste", revisit: ["Software Design (duck typing, Program to an Interface)"] }),
    ...
    module({
      ...
      concepts: [
        ...
        concept({ order: 40, title: "Side Effects", requires: ["Programming Fundamentals / Encapsulation"], note: "ensinar antes de Pure Functions", revisit: ["Concurrency / Shared State", "AI / determinismo"] }),
        concept({
          order: 50,
    ...
    module({
      ...
      concepts: [
        ...
        concept({ order: 50, title: "Hash Table", requires: ["Array"], revisit: ["Architecture / Consistent Hashing", "Platform / índices"] }),
        ...
        concept({ order: 80, title: "Binary Search Tree", requires: ["Tree"], revisit: ["Platform / índices B-tree"] }),
    ...
    module({
      ...
      concepts: [
        ...
        concept({ order: 60, title: "Event Loop", requires: ["Call Stack", "Task Queue"], note: "modelo do JS / runtimes event-loop", revisit: ["Frontend (SUGESTÃO Epic)", "Node.js"] }),
        concept({ order: 70, title: "Microtask Queue", requires: ["Event Loop", "Task Queue"], note: "específico de runtime (JS)" }),
        concept({ order: 80, title: "Promise", requires: ["Callback", "Microtask Queue"], revisit: ["AI / Streaming", "Platform / SSE"] }),
    ...
    module({
      ...
      concepts: [
        ...
        concept({ order: 30, title: "Thread", requires: ["Process"], revisit: ["Platform", "Kubernetes"] }),
        concept({
          order: 40,
          title: "Shared State",
        ...
        concept({ order: 50, title: "Race Condition", requires: ["Shared State"], revisit: ["Platform / DB (Optimistic/Pessimistic Locking, Isolation Levels)"] }),
        ...
        concept({ order: 100, title: "Deadlock", requires: ["Mutex", "Semaphore"], revisit: ["Platform / DB", "Architecture (deadlock distribuído)"] }),
