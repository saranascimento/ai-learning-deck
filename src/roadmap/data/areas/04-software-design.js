  ...
  modules: [
    module({
      ...
      concepts: [
        ...
        concept({ order: 80, title: "Anemic Domain Model", requires: ["Entity"], note: "modelo onde o objeto só guarda dados, sem comportamento" }),
    ...
    module({
      ...
      concepts: [
        ...
        concept({ order: 60, title: "Aggregate", requires: ["Entity", "Value Object"], note: "cluster de objetos tratado como uma unidade de consistência" }),
