 ...
 * roadmap/02-testing-quality-engineering.md e roadmap/03-software-craft.md (Fase 2). Este
 * arquivo reflete exatamente a estrutura aprovada — não reorganizar conteúdo, não alterar
 * Requires, não criar Tasks aqui. Alterações de estrutura passam pelos arquivos de roadmap
 * primeiro.
 *
 * Epics 01, 02 e 03: Fase 2 concluída → navegáveis até Conceito.
 * Epics 04–07: Fase 1 apenas → visíveis, "em estruturação", sem drill-down.
 *
