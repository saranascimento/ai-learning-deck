 ...
 * roadmap/02-testing-quality-engineering.md, roadmap/03-software-craft.md e
 * roadmap/04-software-design.md (Fase 2). Este arquivo reflete exatamente a estrutura
 * aprovada — não reorganizar conteúdo, não alterar Requires, não criar Tasks aqui.
 * Alterações de estrutura passam pelos arquivos de roadmap primeiro.
 *
 * Epics 01–04: Fase 2 concluída → navegáveis até Conceito.
 * Epics 05–07: Fase 1 apenas → visíveis, "em estruturação", sem drill-down.
 *
    ...
    epic({
      ...
      stories: [
        ...
        story({
          ...
          requires: ["Dependency Injection & IoC"],
          summary:
            "Repository como base → Data Mapper × Active Record → Unit of Work → Service Layer → Specification e " +
            "DTO. Depende também de Platform / Database Fundamentals (Epic 05, futuro) — sem Requires formal por ora.",
          tasks: [
